...
const Createpost = () => {
  return (
    <div className='bg-blue-500 min-h-screen w-full flex justify-center'>
        <form action="#">
                ...
                <div className='mx-10 my-2 font-oswald text-xl items-center justify-center'>
                    ...
                    <div className='grid grid-cols-2 space-x-2 '>
                        <div className='grid gap my-4 space-y-2 '>
                            ...
                            <input type="text" name="city" id="city" className='border border-black rounded-3xl text-center font-mono'  />
                        </div>

                        <div className='grid gap my-4 space-y-2' >
                            <label className='ml-2'>Location Type</label>
                            <select name="loctype" id="loctype" className='border border-black rounded-3xl text-center font-mono'>
                    ...
                    <div className='grid grid-cols-2 space-x-2'>
                        <div className='grid gap my-4 space-y-2'>
                            ...
                            <input type="number" name="price" id="price" className='border border-black rounded-3xl text-center font-mono' />
                        </div>
                        
                        <div className='grid gap my-4 space-y-2'>
                            <label className='ml-2'>Surface <span className='text-sm'>(m2)</span></label>
                            <input type="number" name="city" id="city" className='border border-black rounded-3xl text-center font-mono' />
                        </div>
                    </div>

                    <div className='grid gap my-4 space-y-2'>
                        <label className='ml-2'>Tel</label>
                        <input type="text" name="tel" id="tel" className='border border-black rounded-3xl text-center font-mono' />
                    </div>

                    <div className='grid gap my-4 space-y-2'>
                        <label className='ml-2'>Address</label>
                        <textarea name="adrs" id="adrs" className='px-1 border border-black font-light'></textarea>
                    </div>
                </div>
